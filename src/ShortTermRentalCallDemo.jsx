...
const scenarios = {
  ...
  checkIn: {
    ...
    consoleAgent: `Naya · ${EXAMPLE_OPERATOR}`,
    replayLabel: 'Replay check-in question',
  ...
  cleaner: {
    ...
    consoleAgent: `Naya · ${EXAMPLE_OPERATOR}`,
    replayLabel: 'Replay turnover delay',
...
export default function ShortTermRentalCallDemo() {
  const [activeKey, setActiveKey] = useState('urgent');
